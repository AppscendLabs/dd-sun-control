        ...
        <div className="relative mx-auto max-w-7xl px-4 py-32 text-center sm:px-6 lg:px-8">
          ...
          >
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-2 text-sm font-medium text-white backdrop-blur-sm">
              ...
              <span>North Little Rock, AR · Serving Central Arkansas &amp; NWA</span>
            </div>
      ...
      <section className="bg-slate-50 py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-10 text-center">
            ...
            >
              Serving Central Arkansas &amp; Beyond
            </motion.h2>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              className="text-xl text-slate-600"
            >
              Professional window tinting throughout the greater Little Rock metro area
            </motion.p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-5">
            {SERVICE_AREAS.map((area, index) => (
              ...
              >
                <MapPin className="h-4 w-4 shrink-0 text-yellow-500" />
          ...
          >
            Don&apos;t see your city?{" "}
            <Link href="/contact" className="font-semibold text-yellow-600 hover:text-yellow-700">
              Contact us
            </Link>{" "}
            — we travel throughout Arkansas for large commercial and residential projects.
          </motion.p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mx-auto mb-8 max-w-2xl text-xl text-white/90">
              Contact us today for a free consultation and quote. Our team in
              North Little Rock is ready to help you choose the perfect tinting solution.
            </p>
            <Link
              href="/contact"
